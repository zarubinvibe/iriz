...
enum FirstRunCopy {
    ...
    /// Подпись под самой клавишей. Говорит, что делать, а не что случилось:
    /// человек смотрит на клавишу, и объяснение обязано быть там же.
    static var changeKeyHint: String { L("firstrun.changeKeyHint", "Клавиша занята? Нажми на неё и задай своё сочетание") }
    ...
    static var whereItLives: Step { Step(
        ...
        body: L("firstrun.whereItLives.body", "В доке меня не ищи: мой значок наверху справа, рядом с часами. "
            + "Нажми на него, и раскроется меню."),
        note: L("firstrun.whereItLives.note", "Из этого меню открываются история, словарь, настройки и запись встречи. "
            + "Там же видно, чем я занят прямо сейчас.\n\n"
            + "Запускаюсь вместе с Маком. Не надо, выключи это в настройках.")
    ) }
    ...
    static var accessibility: Step { Step(
        ...
        note: L("firstrun.accessibility.note", "Без него я разберу речь, но вставить ее будет некуда. В открывшемся списке "
            + "найди iriz и включи переключатель: система не даёт сделать это за тебя: только человек своими руками."),
    ...
    static var whenItBreaks: Step { Step(
        ...
        body: L("firstrun.whenItBreaks.body", "Текст не вставился? Он не потерян. Плашка развернется и покажет его, оттуда "
            + "можно скопировать."),
        note: L("firstrun.whenItBreaks.note", "Расслышал слово неправильно? Просто поправь его прямо в тексте. "
            + "Я замечу правку и спрошу, запомнить ли её: согласишься, и дальше буду писать как надо. "
            + "Сам, без спроса, я в словарь ничего не кладу."
            + "\n\nКлавиша занята другой программой? Нажми на неё в настройках и задай своё сочетание."
