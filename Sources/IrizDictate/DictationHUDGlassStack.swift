...
final class DictationHUDGlassStack: NSView {
    ...
    override init(frame frameRect: NSRect) {
        ...
        // Прозрачное стекло, а не матовое. Решение владельца 06.09.2026:
        // «всё стекло, которое просто без текста или без каких-то выделений
        // снизу, должно быть максимально прозрачным, как это уже сделано в
        // настройках… в том числе это стекло у самой плашки».
        //
        // Текста по стеклу плашки не идёт ни в покое, ни на записи: там лента
        // и черта, а панель расшифровки кладёт свои буквы на СВОЮ плотную
        // подложку. Значит правило применимо целиком.
        //
        // Замер прибором `--probe-plate`: `.regular` давал пропускание 0.244
        // в покое и 0.112 на записи при эталоне окна настроек 0.678.
        body.style = .clear
