// Движок моделей Whisper через whisper.cpp.
//
...
// 44,05 процента ошибок против 19,05 у полной Whisper large-v3 с промтом. На коротких
// русских файлах Parakeet работал в 21-29 раз быстрее записи, а full large-v3 - в 1,3.
// Turbo этот замер не покрывал, поэтому его скорость и качество из цифр не выводим.
//
...
/// Общий каталог моделей Whisper. Большие файлы весов лежат вне репозитория.
...
/// Замер 03.09.2026 дал на полной large-v3 с этой строкой 19,05 процента ошибок
/// на смешанной речи против 26,19 без нее.
///
...
final class WhisperEngine {
    ...
    /// Подсказка декодеру. На полной large-v3 замер дал 26,19 в 19,05 на срезе
    /// с английскими терминами. Промт задает СТИЛЬ, а не словарь ответов -
