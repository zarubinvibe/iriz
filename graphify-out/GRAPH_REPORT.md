# Graph Report - iriz-download.qHFbKa  (2026-09-14)

## Corpus Check
- 276 files · ~1,726,953 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4008 nodes · 7942 edges · 245 communities (194 shown, 51 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 1432 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0fceb1eb`
...
- `DictationHUDVerdictTests` --calls--> `DictationHUDStage`  [INFERRED]
  Tests/IrizDictateTests/DictationHUDTests.swift → Sources/IrizDictate/DictationHUD.swift
- `DictationHUDMotionTests` --calls--> `DictationHUDContent`  [INFERRED]
  Tests/IrizDictateTests/DictationHUDTests.swift → Sources/IrizDictate/DictationHUD.swift
...
Cohesion: 0.07
Nodes (19): fields, MeetingSource, meetingSpeakerTurns(), MeetingTranscriptSnapshot, distance(), speakerForToken(), SpeakerSpan, SpeakerTurn (+11 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (57): applyInputDevicePreference(), applyShutdownPolicyAfterRecording(), AudioConverterInputProvider, audioDeviceHasInputChannels(), AudioEngineStartRetry, AudioInputDevice, audioInputDeviceNominalSampleRate(), audioObjectStringProperty() (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (24): DictationHUDHintView, installSpeakerModelFiles(), SpeakerModelDownloadDelegate, speakerModelDownloadURL(), SpeakerModelFile, SpeakerModelInstaller, SpeakerModelManifest, speakerModelRedirectAllowed() (+16 more)
...
Cohesion: 0.07
Nodes (44): BlindDecision, tie, v1, v2, BlindLabelDecision, first, second, tie (+36 more)
...
Cohesion: 0.04
Nodes (40): Equatable, Identifiable, LayoutEntry, DictationHousekeepingItem, DictationHUDLevelTrail, DictionaryImportOutcome, PromptAgentAdapter, PromptAgentCatalog (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (39): dictationHUDPerceptualLevel(), DictationHUDGlassForm, done, listening, resting, thinking, transcript, vanishing (+31 more)
...
Cohesion: 0.07
Nodes (26): consumeProgress(), printProgress(), ProgressLine, refuse(), Transcribe, TranscriptionRunner, TranscriptOutcomeError, cannotWrite (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.12
Nodes (4): CodexPromptGeneratorTests, PromptEnvelopeInsertedTextTests, PromptEnvelopeBuilder, data()
...
Cohesion: 0.05
Nodes (42): Codable, MeetingMinutesData, ASRTimingBreakdown, allRanges(), matches(), PromptAmbiguityKind, blockingUserChoice, discoverable (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (7): dictationHUDRibbonStrandParameters(), DictationHUDCapsuleBackgroundStyle, dark, light, system, DictationHUDCapsuleView, WaveGeometry

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (40): dictationHUDAccessibilityLabel(), dictationHUDClampedAxis(), dictationHUDClampedFrame(), DictationHUDContent, dictationHUDDetail(), dictationHUDFormShowsChip(), dictationHUDHasLatin(), dictationHUDHintLines() (+32 more)
...
Cohesion: 0.08
Nodes (13): DictationHUDSurface, DictationHUDAction, DictationHUDActionButton, dictationHUDActions(), dictationHUDLanguageBadge(), dictationHUDNextLanguage(), dictationHUDStripActions(), DictationHUDNotificationObserver (+5 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (22): MeetingAgentConsent, MeetingProcessingChoice, cancel, fill, localOnly, CodexPromptGenerator, CodexPromptGeneratorError, invalidExecutable (+14 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (19): IrizConnector, googleCalendar, zoom, IrizConnectorConsent, ConnectorsTests, SuperDictateImportResult, imported, nothingToImport (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (33): CaseIterable, DictationHUDPreviewPurpose, dictation, prompt, DictationCompletionBehavior, insert, insertAndEnter, PasteSuffix (+25 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (3): FirstRunAgent, FirstRunModel, FirstRunWindowController

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (21): BlindLabel, a, b, DictationLearnedPair, dictationLearnedPairs(), dictationLearningDistance(), dictationLearningPairIsUsable(), dictationLearningSimilar() (+13 more)
...
Cohesion: 0.12
Nodes (15): DictationLanguage, whisperCoreMLEncoderURL(), WhisperEngine, WhisperEngineError, contextFailed, modelMissing, transcribeFailed, whisperModelCacheDirectory() (+7 more)
...
Cohesion: 0.14
Nodes (14): dictationHUDAnimatesWaiting(), dictationHUDDismissDelay(), dictationHUDFrame(), DictationHUDLevelPump, DictationHUDDismissTests, DictationHUDFrameTests, DictationHUDLevelPumpTests, DictationHUDMotionTests (+6 more)
...
Cohesion: 0.12
Nodes (11): DictationTimings, DictationTokenTiming, MeetingResult, MeetingProtocolDocument, meetingTimestamp(), SpeakerNames, DictationTimingsShapeTests, DictationTimingsStoreTests (+3 more)

### Community 37 - "Community 37"
Cohesion: 0.11
Nodes (16): dictationTokenTimings(), FileSystemNodeType, directory, regularFile, LoadedSpeechEngine, parakeetV3, whisper, speechModelCacheDirectory() (+8 more)
...
Cohesion: 0.09
Nodes (12): AnyObject, IrizResourceBundleMarker, DictationHUDContainerDelegate, DictationHUDContainerView, DictationHUDDisplayLinkProxy, DictationHUDDisplayLinkStorage, DictationHUDFirstShowMetric, dictationHUDHitTarget() (+4 more)
...
Cohesion: 0.15
Nodes (11): dictationHUDRibbonStrandWeight(), DictationHUDFrameLog, measureDictationHUDFirstShow(), dictationHUDWaveDisabledByEnvironment(), dictationHUDWavePhase(), DictationHUDWaveRenderer, DictationHUDWaveScene, DictationHUDWaveUniforms (+3 more)
...
Cohesion: 0.12
Nodes (6): DictationHUDDropMarksView, DictationHUDDropZoneView, makeDictationHUDDropZoneWindow(), DictationHUDGlassStack, DictationHUDHaloView, NSView

### Community 49 - "Community 49"
Cohesion: 0.15
Nodes (10): DictationRescue, DictationTextProcessingResult, Match, Outcome, pastedText(), processedDictationText(), removingFinalPeriod(), Rule (+2 more)
...
Cohesion: 0.11
Nodes (18): Decodable, AmbiguityExpectation, blocking, nonBlocking, none, BaselineCase, BaselineExpected, FailureStage (+10 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (22): FirstRunPermission, accessibility, inputMonitoring, microphone, DictationHUDWavePalette, calm, mono, spectral (+14 more)
...
Cohesion: 0.13
Nodes (11): dictationHUDAnimationDuration(), DictationHUDHoverLayers, dictationHUDLevelIsStale(), dictationHUDNormalizedLevel(), DictationHUDRevealLayers, dictationHUDShowsDragHint(), dictationHUDSmoothedLevel(), dictationHUDSmootherstep() (+3 more)

### Community 56 - "Community 56"
Cohesion: 0.18
Nodes (4): migrateSmltlkPrivateFilePermissionsOnce(), SuperDictateImporterTests, DictationSleepRecoveryTests, DictationUIToggleTests

### Community 57 - "Community 57"
Cohesion: 0.17
Nodes (7): audioDurationSeconds(), speakerDiarizationModelURLs(), speakerDiarizationPLDAPsi(), SpeakerDiarizer, speakerSpans(), SpeakerDiarizationTests, ROOT
...
Cohesion: 0.12
Nodes (14): SpeechModelDownloadProgress, speechModelDownloadURL(), SpeechModelInstaller, SpeechModelInstallPhase, compiling, downloading, failed, finished (+6 more)
...
Cohesion: 0.11
Nodes (18): MeetingAlignedWord, meetingAlignedWords(), MeetingSpeakerQuality, diarized, partial, unavailable, MeetingTimingQuality, aligned (+10 more)
...
Cohesion: 0.17
Nodes (8): TranscriptCorrection, DictionaryTransferDocument, TranscriptCorrectorTests, DictionaryTemplateTests, DictionaryTransferMergeTests, DictionaryTransferRefusalTests, DictionaryTransferRoundTripTests, json()
...
Cohesion: 0.14
Nodes (13): dictationInputIsProtected(), DictationRecordingPurpose, dictation, meeting, prompt, translation, promptInsertionAllowed(), TextInsertionFailure (+5 more)
...
Cohesion: 0.12
Nodes (15): CodingKey, AnyKey, CodingKeys, blocks, CodingKeys, end, hasKnownTiming, speaker (+7 more)

### Community 80 - "Community 80"
Cohesion: 0.17
Nodes (5): main(), wer(), main(), FillerTests, RobustnessTests
...
Cohesion: 0.12
Nodes (16): Error, TranscriptCorrectionDefect, emptyReplacement, emptySource, forbiddenCharacter, replacementTooLong, sourceTooLong, MeetingRecorderFailure (+8 more)
...
Cohesion: 0.22
Nodes (7): PromptAppProfileMapTests, PromptAppProfileSettingsTests, normalizedPromptAppProfileEntries(), PromptAppProfileEntry, promptAppProfileLookupKey(), PromptAppProfileMap, validatedPromptAppProfileBundleID()
...
Cohesion: 0.26
Nodes (13): DictationHistoryShotKind, empty, list, rescue, fill(), main(), Replace once, right to left, keeping the surrounding runs and their styles., replace_empty() (+5 more)

### Community 94 - "Community 94"
Cohesion: 0.18
Nodes (4): in_slice(), Смешанная запись - та, где в эталоне есть латиница. Иначе чистая., MeasureSliceTests, SliceRuleTests
...
Cohesion: 0.22
Nodes (13): cleanedExternally(), generateAndDeliverPrompt(), handleRelease(), offerRecovery(), PromptPipelineError, artifactAlreadyExists, codexUnavailable, verificationFailed (+5 more)

### Community 105 - "Community 105"
Cohesion: 0.23
Nodes (6): DictationStartRefusal, alreadyRecording, modelNotReady, secureInputActive, transcriptionInFlight, DictationStartRefusalTests

### Community 106 - "Community 106"
Cohesion: 0.24
Nodes (4): speechModelInstallFraction(), ModelFileDigest, ModelIntegrityTests, SpeechModelInstallTests
...
Cohesion: 0.17
Nodes (11): AppProfileAddOutcome, added, invalidBundleID, listFull, updated, LayoutHotkeyConfig, LayoutHotkeySettingsAccess, LayoutMode (+3 more)
...
Cohesion: 0.15
Nodes (10): SettingsSectionSpec, appearance, appProfiles, behavior, corrections, layout, promptGuidance, promptMode (+2 more)
...
Cohesion: 0.2
Nodes (4): irizDropAccepts(), IrizDropRow, IrizDropZone, IrizDropZoneButton
...
Cohesion: 0.18
Nodes (10): DictationRecoverySilence, delivered, mayHaveBeenInserted, nothingToShow, turnedOff, verdictNotFinal, DictationRescueRetryOutcome, focusDidNotReturn (+2 more)

### Community 129 - "Community 129"
Cohesion: 0.27
Nodes (7): promptAgentRefused(), promptFailureKind(), safePromptFailureLogLabel(), PromptFailureKindTests, PromptFocusTests, WarmUpDoesNotBlockRecordingTests, PromptAgentRefusalTests
...
Cohesion: 0.42
Nodes (8): appendPrivateLogData(), applyPrivatePermission(), createPrivateDirectory(), currentPOSIXError(), irizApplicationSupportDirectory(), posixError(), validateSingleLinkRegularFileDescriptor(), writeAllData()
...
Cohesion: 0.2
Nodes (5): AudioEngineStartRetryTests, AudioGraphRecoveryFailureTests, SyntheticAudioStartError, first, second
...
Cohesion: 0.36
Nodes (7): applyDefaults(), DefaultCorrectionsSyntheticCorpusTests, DefaultCorrectionsTrapTests, PunctuationMetrics, SyntheticCorpusEntry, SyntheticCorrectionCorpus, SyntheticPunctuationGuardTests
...
Cohesion: 0.22
Nodes (8): AppMode, fixing, paused, shadow, DictationHint, fault, key, note
...
Cohesion: 0.39
Nodes (6): DictationRecoveryPresentation, rescueWindow, stayQuiet, DictationRecoveryPresentationTests, DictationRescueModelTests, DictationRescueSettingTests

### Community 174 - "Community 174"
Cohesion: 0.36
Nodes (5): dictationHistoryShotEntries(), dictationHistoryShotView(), DictationHistoryView, dictationRescueExplanation(), DictationRescueTextTests
...
Cohesion: 0.29
Nodes (7): MeetingMinutesGenerationError, agentFailed, agentTimedOut, agentUnavailable, inputTooLarge, invalidResponse, invalidSource
...
Cohesion: 0.4
Nodes (5): MeetingPipelineFailure, audioUnreadable, nothingRecognized, storeFailed, transcriptionFailed
...
## Knowledge Gaps
- **784 isolated node(s):** `answer`, `failure`, `cancellation`, `first`, `second` (+779 more)
...
- **Why does `data()` connect `Community 11` to `Community 1`, `Community 130`, `Community 3`, `Community 133`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 143`, `Community 18`, `Community 20`, `Community 21`, `Community 153`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 156`, `Community 158`, `Community 157`, `Community 36`, `Community 165`, `Community 45`, `Community 46`, `Community 56`, `Community 57`, `Community 70`, `Community 72`, `Community 202`, `Community 75`, `Community 80`, `Community 86`, `Community 87`, `Community 92`, `Community 226`, `Community 102`, `Community 103`, `Community 106`, `Community 107`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `DictationSettings` connect `Community 28` to `Community 160`, `Community 225`, `Community 66`, `Community 34`, `Community 102`, `Community 8`, `Community 107`, `Community 173`, `Community 111`, `Community 176`, `Community 179`, `Community 21`, `Community 55`, `Community 87`, `Community 56`, `Community 153`, `Community 191`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `L()` connect `Community 25` to `Community 97`, `Community 69`, `Community 6`, `Community 38`, `Community 40`, `Community 174`, `Community 143`, `Community 20`, `Community 118`, `Community 23`, `Community 126`, `Community 59`, `Community 92`, `Community 30`?**
