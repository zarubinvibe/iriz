...
<p align="center"><img src="assets/shots/plate-resting-light.png" alt="Маленькая стеклянная капля внизу экрана, внутри тонкая зеленая черта" width="45%"></p>

Так она выглядит, пока вы молчите. Капля висит поверх любого окна и ничего не делает.

<p align="center"><img src="assets/shots/plate-listening-light.png" alt="Плашка на записи: внутри стекла бежит зеленая звуковая волна" width="70%"></p>

Так — пока вы говорите. Волна внутри стекла и есть ответ на вопрос «слышит ли меня».

<p align="center"><img src="assets/shots/plate-hover-light.png" alt="Плашка раскрыта в ряд из шести круглых кнопок: микрофон, промпт, перевод, RU, история, настройки" width="100%"></p>
...
<p align="center"><img src="assets/shots/plate-open-text-light.png" alt="Раскрытая панель плашки: текст на плотной подложке, кнопка «Скопировать», крестик и ряд кнопок внизу" width="100%"></p>
