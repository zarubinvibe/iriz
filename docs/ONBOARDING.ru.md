...
Так — пока вы говорите. Волна внутри стекла и есть ответ на вопрос «слышит ли меня».
...
Наведите мышь — капля раскроется в ряд кнопок: запись, промпт, перевод, язык, история, настройки. Плашку можно перетащить, она примагнитится к одному из двенадцати мест по краям экрана.
