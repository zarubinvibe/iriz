...
> Привет. Я юрист, у меня две дочки и кофейное дело, и диктую я много: заявления, письма, задания агентам. Готовые диктовки чистят речь отлично, только текст при этом уезжает на чужой сервер, а у меня там имена доверителей и суммы.
>
> iriz появился из этого. Он разбирает речь на моем Маке и молчит наружу. Если вам нужно то же самое, забирайте и делайте своим.
>
> — Филипп Зарубин
...
iriz живет в строке меню и делает три вещи. Чинит раскладку, когда фраза набрана не в той. Пишет текст под диктовку: нажали клавишу, сказали, отпустили. И превращает сбивчивую надиктовку в готовое задание для агента. Речь разбирается прямо на Маке, на Neural Engine.
