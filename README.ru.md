...
Говорите - появляется текст. Речь разбирается на вашем Маке, а не в чужом облаке.
...
iriz живет в строке меню. Чинит раскладку, когда фраза набрана не в той. Пишет текст под диктовку: нажали клавишу, сказали, отпустили. Превращает сбивчивую речь в готовое задание агенту и переводит на ходу.

![Главное окно: история надиктовок и настройки](docs/assets/screens/page-history.png)

Дальше начинается то, ради чего его и доводили. Поправили слово после вставки - iriz это заметил и предложил запомнить замену. Речь чистится от запинок и повторов прямо на машине. Запись встречи или судебного заседания разбирается по говорящим, имена подставляются руками, и рядом со звуком ложится протокол.

![Встречи: перенесите запись, рядом ляжет протокол](docs/assets/screens/page-meetings.png)

Речь разбирается на Маке, на Neural Engine.

## Зачем это нужно

Облачная диктовка чистит речь лучше любой местной. Но наружу уезжает разговор с доверителем, черновик заявления, имена и суммы. Для человека под профессиональной тайной такой обмен не окупается ничем. Поэтому распознавание тут местное, а единственный поход в сеть вы начинаете сами кнопкой.

## Главное преимущество

**Главное преимущество:** распознавание идет на вашей машине, и в диктовке сеть запрещена рубильником, а не обещанием.
...
Нажали клавишу, сказали фразу, нажали еще раз. Текст встает туда, где мигал курсор: в письмо, в чат, в терминал. Не доехал - плашка раскрывается в панель, откуда его можно забрать целиком.

Язык переключается с самой плашки, правым щелчком: его меняют за секунду до того, как заговорить, и ходить за этим в настройки незачем.
...
Глубже: [пошаговое знакомство](docs/ONBOARDING.ru.md), [как помочь](CONTRIBUTING.ru.md), лицензии зависимостей в [THIRD-PARTY](THIRD-PARTY).
